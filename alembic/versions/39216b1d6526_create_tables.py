...
Revision ID: 39216b1d6526
Revises: 
Create Date: 2023-07-23 09:08:54.110343
...
def upgrade() -> None:
    ...
    sa.Column('payment_status', sa.Enum('new', 'paid', 'canceled', name='paymentstatus'), server_default='new', nullable=False),
